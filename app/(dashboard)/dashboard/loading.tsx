    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-2">
          <Skeleton className="h-8 w-72 bg-white dark:bg-[#111111]" />
          <Skeleton className="h-4 w-96 bg-white dark:bg-[#111111]" />
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map(i => (
          <div key={i} className="bg-white dark:bg-[#111111] border border-zinc-200 dark:border-[#1f1f1f] 
            ...
            <Skeleton className="h-8 w-20 bg-zinc-100 dark:bg-zinc-800" />
      ...
      {/* CTA Card */}
      <Skeleton className="h-32 w-full bg-white dark:bg-[#111111]" />

      {/* Recent Scans */}
      <div className="space-y-4">
        <Skeleton className="h-6 w-40 bg-white dark:bg-[#111111]" />
        {[1, 2, 3, 4, 5].map(i => (
