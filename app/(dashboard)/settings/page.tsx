    ...
    <div className="space-y-6 max-w-2xl">
        ...
        <div className="space-y-3 pt-2 border-t border-[#1f1f1f]">
          ...
          {profile?.github_username && (
            <div className="flex items-center gap-3 text-sm">
              <GithubIcon className="h-4 w-4 text-zinc-500" size={16} />
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <Badge className="ml-auto bg-zinc-800 text-zinc-300 border-0 capitalize">
              {profile?.plan ?? 'free'}
            </Badge>
          </div>
        </div>
      ...
      <div className="bg-[#111111] border border-[#1f1f1f] rounded-xl p-6 space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span className="text-zinc-400">Scans used</span>
      ...
      <div className="bg-[#111111] border border-[#1f1f1f] rounded-xl p-6 space-y-3">
        ...
        <div className="text-sm text-zinc-400 space-y-2">
          ...
          <div className="flex justify-between">
            <span>User ID</span>
            <span className="font-mono text-zinc-500 text-xs">{user.id}</span>
          </div>
        </div>
      </div>
    </div>
