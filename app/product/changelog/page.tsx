...
export default function ChangelogPage() {
    const logs = [
        ...
        { version: 'v0.3.0', day: 'Day 3', date: 'Scanner Day', title: 'Security Scanner Pipeline', changes: ['Integrated Semgrep for static analysis', 'Added Ollama Llama 3.1 for deep review', 'Implemented Gitleaks for secret detection', 'Wired BullMQ for background jobs'] },
