                ...
                <section className="max-w-6xl mx-auto px-6 pb-24 flex flex-col md:flex-row gap-12">
                    ...
                    <div className="flex-1 space-y-16 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 fill-mode-both">
                        ...
                        <div id="fixing-issues" className="scroll-mt-24">
                            ...
                            <p className="text-zinc-600 dark:text-zinc-900 dark:text-white/70">Expand any vulnerability card in the report to see the <strong>Remediation Strategy</strong>. This includes a clear explanation generated by Llama 3.1 and an exact, patched code snippet you can copy directly into your codebase.</p>
                        </div>
